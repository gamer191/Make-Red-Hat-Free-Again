"use strict";(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[8029,7641],{52253:(e,s,t)=>{t.r(s),t.d(s,{ServerStats:()=>$});var i=t(77813),a=t(76687),n=t(67273),r=t(27668),l=t(55312),c=t(39262),o=t(352),d=t(69369),h=t(62988),x=t(63003),p=t(75536),g=t(5205),u=t(99397),j=t(68964),m=t(52010);const v=()=>{var e;const s=f((0,r.l4)()),[t,i]=(0,a.useState)(!1),[c,o]=(0,a.useState)({mode:"thumbs",theme:n.v.theme2.isLight?"light":"dark"}),d=()=>i(!1);return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsxs)(u.u,{title:"Start crawler",isOpen:t,onDismiss:d,children:[(0,m.jsx)("div",{className:s.wrap,children:(0,m.jsx)(j.p,{height:200,value:null!==(e=JSON.stringify(c,null,2))&&void 0!==e?e:"",showLineNumbers:!1,readOnly:!1,language:"json",showMiniMap:!1,onBlur:e=>{o(JSON.parse(e))}})}),(0,m.jsxs)(u.u.ButtonRow,{children:[(0,m.jsx)(l.zx,{type:"submit",onClick:()=>{(0,g.i)().post("/api/admin/crawler/start",c).then((e=>{console.log("GOT",e),d()}))},children:"Start"}),(0,m.jsx)(l.zx,{variant:"secondary",onClick:d,children:"Cancel"})]})]}),(0,m.jsx)(l.zx,{onClick:()=>i(!0),variant:"primary",children:"Start"})]})},f=e=>({wrap:i.css`
    ...
    `,row:i.css`
      ...
      margin-bottom: ${e.spacing(2)};
      align-items: center;
    `})},28029:(e,s,t)=>{t.r(s),t.d(s,{UpgradeInfo:()=>R,UpgradePage:()=>E,default:()=>V});var i=t(77813),a=(t(76687),t(30415)),n=t(27668),r=t(55312),l=t(28781),c=t(3276),o=t(20821),d=t(52010);const h={fontWeight:500,fontSize:"26px",lineHeight:"123%"},x=(0,o.B)((e=>{const s=e.isDark?"public/img/licensing/header_dark.svg":"public/img/licensing/header_light.svg",t=e.isDark?e.palette.dark9:e.palette.gray6;return{container:i.css`
      padding: 36px 79px;
  ...
  `,l=i.css`
    font-weight: 500;
    line-height: 1.7;
  `;return(0,d.jsxs)("div",{className:r,children:[(0,d.jsx)("img",{src:n,alt:""}),(0,d.jsxs)("div",{children:[(0,d.jsx)("div",{className:l,children:t}),s]})]})},V=(0,a.connect)((e=>({navModel:(0,c.h)(e.navIndex,"upgrading")})))(E)},62988:(e,s,t)=>{t.d(s,{a:()=>n});t(76687);var i=t(42384),a=t(52010);const n=e=>{let{text:s="Loading..."}=e;return(0,a.jsx)("div",{className:"page-loader-wrapper",children:(0,a.jsx)(i.u,{text:s})})}}}]);
//# sourceMappingURL=8029.9fb105a8b019c441c2c2.js.map